...
static void hci_init_req(struct hci_dev *hdev, unsigned long opt)
{
	...
	char buf1 = 0x01;
	hci_send_cmd(hdev, 0xFC1D, 1, (void*)&buf1);
	/* cofig pcm sync */
	char buf2[3] = {0x03, 0x00, 0x03};
	hci_send_cmd(hdev, 0xFC28, 3, (void*)buf2);
	/* config sd8787 as pcm slave*/
	char buf3 = 0x0;
	hci_send_cmd(hdev, 0xFC07, 1, (void*)&buf3);
#endif
}
...
#ifdef CONFIG_BT_W8787
	error = hci_register_sysfs(hdev);
    pr_info("#### eric hci_register_dev register error = %d", error);
#else
