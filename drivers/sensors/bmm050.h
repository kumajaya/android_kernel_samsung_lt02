...
#define BMM050_OVERFLOW_OUTPUT_S32   ((signed int)(-2147483647-1))
...
char bmm050_write_register(
		unsigned char addr, unsigned char *data, unsigned char len);
char bmm050_get_self_test_XYZ(
		unsigned char *self_testxyz, int *x, int *y, int *z);
signed short bmm050_compensate_X(
		signed short mdata_x, unsigned short data_R);
signed int bmm050_compensate_X_s32(
		signed short mdata_x,  unsigned short data_R);
#ifdef ENABLE_FLOAT
float bmm050_compensate_X_float(
		signed short mdata_x,  unsigned short data_R);
#endif
signed short bmm050_compensate_Y(
		signed short mdata_y, unsigned short data_R);
signed int bmm050_compensate_Y_s32(
		signed short mdata_y,  unsigned short data_R);
#ifdef ENABLE_FLOAT
float bmm050_compensate_Y_float(
		signed short mdata_y,  unsigned short data_R);
#endif
signed short bmm050_compensate_Z(
		signed short mdata_z,  unsigned short data_R);
signed int bmm050_compensate_Z_s32(
		signed short mdata_z,  unsigned short data_R);
#ifdef ENABLE_FLOAT
float bmm050_compensate_Z_float(
		signed short mdata_z,  unsigned short data_R);
#endif
char bmm050_get_raw_xyz(
		struct bmm050_mdata *mdata);
char bmm050_init_trim_registers(void);
char bmm050_set_spi3(
		unsigned char value);
char bmm050_get_powermode(
		unsigned char *mode);
char bmm050_set_powermode(
		unsigned char mode);
char bmm050_set_adv_selftest(
		unsigned char adv_selftest);
char bmm050_get_adv_selftest(
		unsigned char *adv_selftest);
char bmm050_set_datarate(
		unsigned char data_rate);
char bmm050_get_datarate(
		unsigned char *data_rate);
char bmm050_set_functional_state(
		unsigned char functional_state);
char bmm050_get_functional_state(
		unsigned char *functional_state);
char bmm050_set_selftest(
		unsigned char selftest);
char bmm050_get_selftest(
		unsigned char *selftest);
